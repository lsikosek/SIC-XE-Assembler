...
public class MnemonicF4m extends Mnemonic{
	...
	public MnemonicF4m(String name, int opcode, String hint, String desc) {
	...
	public Node parse(Parser parser) throws SyntaxError {
		...
		if (flags.isSimple()) {
			...
			throw new SyntaxError(String.format("Invalid addressing"), parser.lexer.row, parser.lexer.col);
		}
